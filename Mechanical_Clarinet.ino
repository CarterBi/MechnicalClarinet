...
int lastButtonState = LOW, lastButtonState1 = LOW, lastButtonState2 = LOW, lastButtonState3 = LOW, lastButtonState4 = LOW, lastButtonState5 = LOW, lastButtonState6 = LOW, lastSharpState= LOW;
int buttonState, buttonState1, buttonState2, buttonState3, buttonState4, buttonState5, buttonState6, sharpState;
// GUItool: end automatically generated code
unsigned long lastDebounceTime = 0, lastDebounceTime1 = 0, lastDebounceTime2 = 0, lastDebounceTime3 = 0, lastDebounceTime4 = 0, lastDebounceTime5 = 0, lastDebounceTime6 = 0, lastSharpTime = 0;
...
//   
//  int sharpReading = digitalRead(sharpPin);
//
//  if (sharpReading != lastSharpState) {
//    // reset the debouncing timer
//    lastSharpTime = millis();
//  }
//
//  if ((millis() - lastSharpState) > debounceDelay) {
//
//    if (sharpReading != sharpState) {
//      sharpState = sharpReading;
//      if (sharpState== HIGH) {
//        sharp = 5;
//      }
//    }
//  }
//  lastSharpTime = sharpReading;
   //  Serial.println(velocity);
      int sharpReading = digitalRead(sharpPin);
  if (sharpReading != lastSharpState) {
    lastSharpTime = millis();
      }
  if ((millis() - lastSharpTime) > debounceDelay) {
    if (sharpReading != sharpState) {
      sharpState = sharpReading;
      if (sharpState == HIGH) {
